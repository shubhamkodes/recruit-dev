    ...
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Discover a variety of information tailored to your needs. Check out the answers to the most common questions about our platform."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="How does the centralized dashboard benefit recruiters?"
              answer="The centralized dashboard offers a user-friendly interface for managing candidate profiles, interview schedules, and communication logs, enhancing recruiter productivity and streamlining the recruitment process."
            />
            <SingleFaq
              question="What are the advantages of using customizable templates in TalentConnect?"
              answer="Customizable templates ensure consistent and personalized communication with candidates through pre-defined messages for interview invitations, follow-up emails, and feedback requests."
            />
            <SingleFaq
              question="How does TalentConnect handle candidate profile management?"
              answer="TalentConnect provides a comprehensive candidate database with advanced search and filter options, allowing recruiters to efficiently manage and quickly make decisions about candidates."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What analytics and reporting capabilities does TalentConnect offer?"
              answer="TalentConnect features robust analytics and reporting tools to track key recruitment metrics such as time-to-hire, interview-to-offer ratios, and candidate engagement levels, enabling data-driven decision-making."
            />
            <SingleFaq
              question="What automated features does TalentConnect include for interview scheduling?"
              answer="TalentConnect utilizes AI-powered algorithms and integrates with Calendly to automate interview scheduling based on candidate availability and recruiter preferences, reducing no-show rates and optimizing scheduling efficiency."
            />
            <SingleFaq
              question="How does the WhatsApp chatbot enhance candidate engagement?"
              answer="The intelligent WhatsApp chatbot engages candidates in real-time, providing application status updates, interview reminders, and answers to frequently asked questions, improving the overall candidate experience."
            />
          </div>
        </div>
      </div>
